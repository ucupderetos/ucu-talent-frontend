...
// TODO: confirmar con backend — CreateVacancyRequest.contractType es string
// libre, pero el SRS (7.1) lo define como enum. Usamos el enum del SRS acá
// por mejor UX; si el back espera texto libre, este Select sigue funcionando
// igual (el value que manda es un string), solo cambiaría si hace falta
// soportar valores fuera de esta lista.
const CONTRACT_TYPES = [
    { value: "PASANTIA", label: "Pasantía" },
    { value: "FULL_TIME", label: "Full-time" },
    { value: "PART_TIME", label: "Part-time" },
    { value: "ZAFRAL", label: "Zafral" },
];
                ...
                <FieldGroup>
                    ...
                    <div className="grid gap-6 sm:grid-cols-2">
                        <Field data-invalid={Boolean(errors.contractType)}>
                            ...
                            >
                                <SelectTrigger id="contractType" className="w-full" aria-invalid={Boolean(errors.contractType)}>
                        ...
                        <Field>
                            <FieldLabel htmlFor="vacancies">Cantidad de vacantes *</FieldLabel>
                    ...
                    <div className="grid gap-6 sm:grid-cols-2">
                        ...
                        {/* TODO: sin respaldo en el back */}
                        <Field>
                            <FieldLabel htmlFor="zone">Zona / Localidad</FieldLabel>
                            <Input id="zone" placeholder="Pocitos" {...register("zone")} />
                        </Field>
                    </div>
                </FieldGroup>
            </CardContent>

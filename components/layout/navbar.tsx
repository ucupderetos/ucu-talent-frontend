      ...
      <div className="flex h-16 items-center gap-2 px-4">
        ...
        {activeItem ? (
          isNested ? (
            ...
            // pantalla. Las páginas no lo repiten en su contenido, así que si
            // acá no fuera un heading el documento quedaría sin `h1` para
            // lectores de pantalla. Solo cambia la semántica: las clases son
            // las mismas de antes.
